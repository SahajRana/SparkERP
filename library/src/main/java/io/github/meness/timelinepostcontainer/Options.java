...
public class Options {
    ...
    public final Options setImageLoadingView(@LayoutRes int layout) {
       ...
       // View view=LayoutInflater.from(mContext).inflate(R.layout.image_loading,mViewGroup, false);
        //imageLoadingView = (ProgressWheel)view.findViewById(R.id.default_progess_wheel);
