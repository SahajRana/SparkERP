...
public class TimelinePostContainer2 extends FrameLayout implements IListener, View.OnClickListener, View.OnTouchListener {
    ...
    public TimelinePostContainer2(Context context) {
        super(context);
        initProperties();
    }
    ...
    public TimelinePostContainer2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initProperties();
    }
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        // mOptions.setImageLoadingView(view);//(customTypedArray.getResourceId(R.styleable.TimelinePostContainer_tpc_imageLoading, R.layout.image_loading));
    ...
    public TimelinePostContainer2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public TimelinePostContainer2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        initAttrs(attrs);
        initProperties();
    }

    public TimelinePostContainer2 setListeners(Listeners listeners) {
        mListeners = listeners;
        return this;
    }

    public TimelinePostContainer2 setOptions(Options options) {
        mOptions = options;
        return this;
    }
    ...
    public TimelinePostContainer2 setImagePath(String imagePath) {
    ...
    public TimelinePostContainer2 setVideoPath(String videoPath) {
    ...
    private void stopPreviousVideo() {
        if (mPreviousVideoView != null) {
            ...
            TimelinePostContainer2 parentLayout = (TimelinePostContainer2) mPreviousVideoView.getParent();
    ...
    public void prepareVideo(View v) {
        ...
        videoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mediaPlayer) {
                mediaPlayer.setOnBufferingUpdateListener(TimelinePostContainer2.this);
                mediaPlayer.setOnCompletionListener(TimelinePostContainer2.this);
